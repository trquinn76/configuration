...
public class ConfigurationException extends RuntimeException {
	...
	/**
	 * Constructs a new {@link ConfigurationException} with {@code null} as its
	...
	/**
	 * Constructs a new {@link ConfigurationException} with the specified detail
	 ...
	 * automatically incorporated in this {@link ConfigurationException}'s detail
	 * message.
	 *
	...
	/**
	 * Constructs a new {@link ConfigurationException} with the specified cause and
	 ...
	 * constructor is useful for {@link ConfigurationException} that are little more
